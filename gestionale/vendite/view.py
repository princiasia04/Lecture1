...
class View:
    ...
    row1 = ft.Row(controls=[self._txtInNomeP,self._txtInPrezzo, self._txtInQuantita], alignment="CENTER")
    ...
    row2 = ft.Row(controls=[self._txtInNomeC, self._txtInMail, self._txtInCategoria], alignment="CENTER")
    ...
    self._btnStampaInfo =  ft.ElevatedButton(text = "Stampa sommario",
                                     ...
                                     width = 200)
    row3 = ft.Row(controls= [self._btnAdd, self._btnGestisciOrdine, self._btnGestisciAllOrdini, self._btnStampaIndo], alignment="CENTER")
